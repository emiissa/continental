...
@Component({
    selector: 'jhi-remboursement-mt',
    templateUrl: './remboursement-mt.component.html'
})
export class RemboursementMtComponent implements OnInit, OnDestroy {
remboursements: RemboursementMt[];
    ...
    loadAll() {
        this.remboursementService.query().subscribe(
            (res: ResponseWrapper) => {
                this.remboursements = res.json;
            },
    ...
    trackId(index: number, item: RemboursementMt) {
        return item.id;
    }
